...
# saveRDS(res,"~/nzhanglab/project/jrong/mito_LT/scripts/SpotGLM/A200_S6/spotglm_res.rds")


res <- readRDS("~/nzhanglab/project/jrong/mito_LT/scripts/SpotGLM/A200_S6/spotglm_res.rds")
...
saveRDS(all_contrasts,"~/nzhanglab/project/jrong/mito_LT/scripts/SpotGLM/A200_S6/deg_2sided.rds")

all_contrasts <- readRDS("~/nzhanglab/project/jrong/mito_LT/scripts/SpotGLM/A200_S6/deg_2sided.rds")
# remove MT genes
...
pdf_path="~/nzhanglab/project/jrong/mito_LT/scripts/SpotGLM/A200_S6/celltype_deg_top20_2sided_MTremoved.pdf"
