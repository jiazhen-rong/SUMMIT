...
seu <-readRDS("~/nzhanglab/project/jrong/mito_LT/data/Sydney_Bracht/P3A2/seurat_final.rds")
...
# RCTD ratio
rctd_ratio_major = readRDS("../../results/Sydney_Bracht/sample_level/P3A2/RCTD/Dale_P03B2_HCC/RCTD_res.rds")
...
rownames(deconv) = str_remove(rownames(deconv),"-1")
#deconv=as.matrix(deconv)
# create niche by VOI:
maegatk.rse = readRDS("../../data/Sydney_Bracht/P3A2/maegatk_final.rds")
...
voi = read.table(paste0("~/nzhanglab/project/jrong/mito_LT/data/Sydney_Bracht/P3A2/P3A2_voi_be25vaf.tsv"),sep="\t")[,1]
voi = c("15723_G>A","11456_G>A")
...
niche[(niche[,"15723_G>A"]==0) & (niche[,"11456_G>A"]==0) ,
        "Rest"] = 1
...
saveRDS(res,"~/nzhanglab/project/jrong/mito_LT/scripts/SpotGLM/P3A2/spotglm_res.rds")
...
saveRDS(all_contrasts,"~/nzhanglab/project/jrong/mito_LT/scripts/SpotGLM/P3A2/deg_2sided.rds")

all_contrasts <- readRDS("~/nzhanglab/project/jrong/mito_LT/scripts/SpotGLM/P3A2/deg_2sided.rds")
# remove MT genes
...
pdf_path="~/nzhanglab/project/jrong/mito_LT/scripts/SpotGLM/P3A2/celltype_deg_top20_2sided_MTremoved.pdf"
